...
def compute_elo_history(matches: pd.DataFrame, cfg: EloConfig) -> tuple[pd.DataFrame, dict]:
...
def build_features(matches: pd.DataFrame, players_agg: pd.DataFrame, cfg: dict) -> pd.DataFrame:
    ...
    feats["neutral"] = feats["neutral"].astype(int)
    ...
    for side in ("home", "away"):
        ...
        for col in [
            "squad_mean", "top11_mean", "star3_mean", "att_mean", "mid_mean", "def_mean",
            "potential_mean", "potential_top11_mean", "value_mean_eur", "value_top11_eur",
            "wage_mean_eur", "age_mean", "height_mean", "international_reputation_mean",
            "dribbling_mean", "physic_mean",
        ]:
    ...
    for col in [
        "top11_mean", "star3_mean", "att_mean", "mid_mean", "def_mean", "squad_mean",
        "potential_mean", "potential_top11_mean", "value_mean_eur", "value_top11_eur",
        "wage_mean_eur", "age_mean", "height_mean", "international_reputation_mean",
        "dribbling_mean", "physic_mean",
    ]:
...
FEATURE_COLUMNS = [
    ...
    "home_potential_mean","home_potential_top11_mean","home_value_mean_eur","home_value_top11_eur",
    "home_wage_mean_eur","home_age_mean","home_height_mean","home_international_reputation_mean",
    "home_dribbling_mean","home_physic_mean",
    "away_potential_mean","away_potential_top11_mean","away_value_mean_eur","away_value_top11_eur",
    "away_wage_mean_eur","away_age_mean","away_height_mean","away_international_reputation_mean",
    "away_dribbling_mean","away_physic_mean",
    "top11_mean_diff","star3_mean_diff","att_mean_diff","mid_mean_diff","def_mean_diff","squad_mean_diff",
    "potential_mean_diff","potential_top11_mean_diff","value_mean_eur_diff","value_top11_eur_diff",
    "wage_mean_eur_diff","age_mean_diff","height_mean_diff","international_reputation_mean_diff",
    "dribbling_mean_diff","physic_mean_diff",
]
