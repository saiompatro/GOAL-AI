...
...) is just another data/club/<key>_results.csv away. Home-advantage and
K-factor are also read per league from LEAGUES (falling back to the
Premier League defaults below) since different leagues carry different
home-field strength and goal-margin volatility.
"""
import os
import math
import pandas as pd
